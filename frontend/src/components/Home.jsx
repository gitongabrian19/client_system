            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                ...
                <Box sx={{ 
                  ...
                  background: `linear-gradient(to right, #0088FE ${stats.ipUtilization}%, #f5f5f5 ${stats.ipUtilization}%)`,
                  borderRadius: 2,
                  position: 'relative'
                }}>
                  <Typography variant="h2" sx={{ 
                    mb: 1,
                    color: stats.ipUtilization > 50 ? 'white' : 'primary.main',
                    textShadow: stats.ipUtilization > 50 ? '1px 1px 2px rgba(0,0,0,0.3)' : 'none'
                  }}>
                    {stats.ipUtilization}%
                  </Typography>
                  <Typography variant="body2" sx={{ 
                    color: stats.ipUtilization > 50 ? 'white' : 'text.secondary',
                    textShadow: stats.ipUtilization > 50 ? '1px 1px 2px rgba(0,0,0,0.3)' : 'none'
                  }}>
